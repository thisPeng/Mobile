...
import PayInfomationList from "./views/Project/PayInfomationList/PayInfomationList";
import InfoPayment from "./views/Project/PayInfomationList/InfoPayment";
...
export default new Router({
  ...
  routes: [{
    ...
    children: [{
      ...
      {
        path: "/project/payinfomationlist",
        name: "payInfoMationList",
        component: PayInfomationList,
        meta: {
          title: "支付信息"
        }
      },
      {
        path: "/project/infoPayment",
        name: "InfoPayment",

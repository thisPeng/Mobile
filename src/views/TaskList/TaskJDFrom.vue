<template>
  <div class="task">
    <van-cell-group :style="tabsShow ? 'padding-bottom: 300px;' : 'padding-bottom: 30px;'">
      ...
      <van-field :value="$util.formatDate(data[10])" label="解冻日期" :disabled="true" readonly @click="showDate" />
      ...
      <van-field :value="data[34]" label="冻结金额(￥)" :disabled="true" />
      <van-field :value="data[9]" label="解冻金额(￥)" :disabled="true" />

<template>
  <div class="task">
    <van-cell-group :style="tabsShow ? 'padding-bottom: 280px;' : 'padding-bottom: 30px;'">
      ...
      <van-field v-model="data[10]" label="到款日期" @click="showDate" />
      ...
      <van-field v-model="data[34]" label="到款金额(￥)" />
      <van-field v-model="data[12]" label="到款账号" />
      <van-field v-model="data[11]" label="开户行" />
      <van-field v-model="data[13]" label="经手人" />
      <van-field v-model="data[9]" label="批款金额(￥)" />
      <van-field v-model="data[16]" label="批款说明" />

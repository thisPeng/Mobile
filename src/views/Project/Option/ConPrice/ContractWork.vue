<template>
  ...
  <div class="contractwork">
    <van-cell-group>
      ...
      <van-field v-model="cspList[31]" label="甲方" placeholder="请输入甲方" required/>
      <van-field v-model="cspList[39]" label="乙方" placeholder="请输入乙方" required/>
      ...
      <van-field v-model="cspList[22]" label="保质期（天）" placeholder="请输入保质期（天）" required/>
      <van-cell-group class="con-price">
      ...
      <van-field v-model="cspList[28]" label="乙方违约(‰)" placeholder="请输入乙方违约" required/>
      <van-field v-model="cspList[29]" label="甲方违约(‰)" placeholder="请输入甲方违约" required/>
      ...
      <van-field v-model="cspList[37]" label="甲方代表人" placeholder="请输入甲方代表人" required/>
      <van-cell-group class="con-price">
      ...
      <van-field v-model="cspList[45]" label="乙方代表人" placeholder="请输入乙方代表人" required/>
      <van-cell-group class="con-price">
        ...
        root: [
          ...
          },
          {
            BC_SC_Order_Contract: [
              ...
              {
                Ensure_Begin_Date: cspList[23]
              },
              {
                Ensure_End_Date: cspList[24]
              },
              {
              ...
              {
                Partner_Sign_Date: cspList[38]
              },
              {
                Supplier_Sign_Date: cspList[46]
              },
              {

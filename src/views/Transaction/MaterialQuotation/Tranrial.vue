<template>
  ...
  <div class="tranrial">
    ...
    <van-cell-group>
      ...
      <!-- <van-field v-model="info[17]" label="订货有效期:" v-if="info[39] !== '已报价'" /> -->
      ...
      <van-field v-model="info[18]" label="业务员:" :disabled="info[39] !== '待报价'" />
      <van-field v-model="info[25]" label="创建日期:" disabled />
      <van-field v-model="info[21]" label="备注:" type="textarea" :disabled="info[39] !== '待报价'" />
